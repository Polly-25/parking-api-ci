...
def test_time_out_after_time_in(client):
    create_client_response = client.post("/clients", json={
        "name": "TimeTest",
        "surname": "User",
    ...
    create_parking_response = client.post("/parkings", json={
        "address": "Timer",
        "opened": True,
        "count_places": 4
    })
    ...
    enter = client.post("/clients_parkings", json={
        "client_id": client_id,
    ...
    response = client.delete("/clients_parkings", json={
        "client_id": client_id,
        "parking_id": parking_id
    })
